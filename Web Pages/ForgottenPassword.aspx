<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgottenPassword.aspx.cs" Inherits="NordShore.Web_Pages.ForgottenPassword" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>NordShore: Forgotten Password</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <!-- Sub-Titles -->
            <asp:Label Text="Forgotten Password" runat="server" class="newsTitle" Style="left: 38.5vw; color: darkblue; top: 14vh" />

            <!-- Text Boxes -->
            <asp:TextBox ID="username" placeholder="Enter your username" runat="server" class="textBox" Style="top: 29vh; left: 38vw;" />
            <asp:TextBox ID="Email" placeholder="Enter your Email" runat="server" class="textBox" Style="top: 36vh; left: 38vw;" />

            <!-- Error Labels -->
            <asp:Label ID="errorLabel" Text="" class="validate" style="top: 20vw; left: 41.5vw" runat="server" />

            <!-- Buttons -->
            <asp:Button ID="getCode" OnClick="getCode_Click" Text="Get Reset Code" runat="server" class="containerButtons" style="left: 42vw; top: 44vh"/>
